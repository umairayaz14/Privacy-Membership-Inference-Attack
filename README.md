...
Expected Process:
The script will sequentially train the 8 shadow models, extract the logit-scaled confidence scores, apply the offline calibration strategy, and generate a submission.csv file. It will then automatically submit this file to the evaluation server using the embedded API key.
